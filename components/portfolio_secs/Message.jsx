...
export default function Message() {
  ...
  return (
    <section className="mt-36 flex h-screen flex-col items-center justify-center">
      <h1 className="mb-8  text-center text-4xl">Let's talk</h1>
      <form
      ...
      >
        ...
        />
        {errors.userName && <p className='-mt-3 mb-2'>Name is required.</p>}
        <input
        ...
        />
        {errors.userMessage && <p className='-mt-3 mb-4'>Don't be shy! Say something.</p>}
        <button
          type="submit"
      ...
      <div>
        <h6 className='text-2xl mt-20'>Or you can contact me with these options</h6>
        <div className="flex w-full justify-center gap-x-8 items-center mt-10 text-accent">
        {socials.map((social, index) => index>1? (
          <div key={`${social.name}${index}`}>
